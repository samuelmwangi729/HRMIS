...
?>
    ...
    <head>
		...
		<meta name="description" content="NewHRMS Provides the best attendance management software, Now you can easily manage your employee attendance efficiency.">
                  ...
                  <div class="secondary-nav-link text-center">
                    ...
                    <ul class="list-unstyled list-inline">
                      ...
                      <li>
                        ...
                        <a href="attendance-management-software" class="active center-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
                        	...
                        	<div class="features-pad">
                                ...
                                <h1>Attendance Management Software</h1>



                                <p>The real time software is Attendance processing which connects the managers with employees. There is a requirement of fixing the ASAP issues but it is not processing at the month end. Our <a href="https://www.newhrms.com/attendance-management-software">Attendance Management System</a> is vey efficiency and simple to handle. So, you can get best experience when the system integrates with our software.</p>
                                ...
                                <div id="attendance">
                                	...
                                	<div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#attendance" href="#attendance1" aria-expanded="true">Utilize different sources</a>
                                        ...
                                        <div id="attendance1" class="collapse in">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Use the ESS portal.</li>



                                                <li>Adopt the hardware from third party.</li>



                                                <li>Regulate real time attendance.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#attendance" href="#attendance2">Features of geo mark attendance</a>
                                        ...
                                        <div id="attendance2" class="collapse">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Avoid the extra attendance devices.</li>



                                                <li>Record the attendance from mobile apps.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#attendance" href="#attendance3">ESM (Extensive Shift Management)</a>
                                        ...
                                        <div id="attendance3" class="collapse">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Make the policies as per shifts.</li>



                                                <li>Assign the employees for shifts.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#attendance" href="#attendance4">Process of attendance</a>
                                        ...
                                        <div id="attendance4" class="collapse">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Access the real time information of the attendance.</li>



                                                <li>Report the real time information.</li>



                                                <li>Configured the attendance to view.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#attendance" href="#attendance5">Employee attendance register portal</a>



                                        <div id="attendance5" class="collapse">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Regulate the employee attendance.</li>



                                                <li>View the fulfilled data.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#attendance" href="#attendance6">Strong policies for configuration</a>



                                        <div id="attendance6" class="collapse">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Create the group to share the policies among employees.</li>



                                                <li>Make the one time activity and standard scheme.</li>



                                                <li>Use logic computation for getting actual data.</li>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-3 sm-mb-41">
              ...
              <div class="logo"><a href="index.html"><img src="assets/img/logo-white-footer.png" alt="Images"/></a></div>
