...
?>
    ...
    <head>
		...
		<meta name="description" content="Newhrms provides the most reliable cloud-based leave management software, It helps you to manage your employee's leave information with single click.">
                  ...
                  <div class="secondary-nav-link text-center">
                    ...
                    <ul class="list-unstyled list-inline">
                      ...
                      <li>
                        ...
                        <a href="leave-management-software" class="active center-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 md-mt-5 ml-auto">
                        	...
                        	<div class="features-pad">
                                ...
                                <h1>Employee Leave Management Software</h1>



                                <p>For multiple concerns, <a href="https://www.newhrms.com/leave-management-software">employee leave management</a> is must to be streamlining the process through a single stroke. Leave management is best opportunity to neglect the issues in the leave administration in the middle of busy work. Employee can easy to follow up and consuming cost and time. It helps to develop the satisfaction among employees and transparency. Our Leave Management software can handle the period activities, grants and accountings. </p>
                                ...
                                <div id="leave">
                                	...
                                	<div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#leave" href="#leave1" aria-expanded="true">Customized policies</a>
                                        ...
                                        <div id="leave1" class="collapse in">
                                        	...
                                        	<ol>
                                                ...
                                                <li>Make the leave policies as fully customized.</li>



                                                <li>Configure the leave policies.</li>



                                                <li>Access only standardized policies.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#leave" href="#leave2">Generate the lists for holidays</a>



                                        <div id="leave2" class="collapse">
                                        	...
                                        	<ol>
                                                ...
                                                <li>Create the holiday lists.</li>



                                                <li>Make the regional based lists.</li>



                                                <li>Include some restricted holidays.</li>



                                                <li>Establish the holidays list of the company.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#leave" href="#leave3">Minimal queries and leave based tasks</a>



                                        <div id="leave3" class="collapse">
                                        	...
                                        	<ol>
                                                ...
                                                <li>Provide the leave automatically.</li>



                                                <li>Management for handling the leave requests.</li>



                                                <li>Access all the leave reports.</li>



                                                <li>Give importance for HR strategic tasks.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#leave" href="#leave4">Year-end leave procedure</a>



                                        <div id="leave4" class="collapse">
                                        	...
                                        	<ol>
                                                ...
                                                <li>Automatic year end process.</li>



                                                <li>There is no extra works at all.</li>



                                                <li>Select the manual method for convenience.</li>
