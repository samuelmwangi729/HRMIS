					...
					<div class="row xs-style vertical-align">
						...
						<div class="col-sm-8 col-xs-6">
							...
							<ul class="mainnav">
								...
								<li class="hidden-xs"><a href="<?=base_url()?>"  class="call-to-action">Home page</a></li>
													...
													<ul>
														...
														<li>
															...
															<li>
																...
																<a href="<?=base_url()?>home/mobile_app" class="active center-block">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-lg-push-6 col-md-6 col-md-push-6 image-column features-slide features-left-blk">
						...
						<div class="features-pad">
							...
							<div class="img-box shadow-lg">
								...
								<img class="img-center" src="<?php echo base_url()?>assets/img/mobile-screens.png" alt="">
					...
					<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
						...
						<div class="features-pad">
							...
							<p>The application is not a word because it is spread throughout the world and it is a great differential for us to have a native application. The application is everywhere. Especially, the workplace should be used the application for the employee portal. All companies should use the employee portal application to attract and provide the best services. In this modern world, the functional mobile app is fully automatic which is required to manage employees.</p>

							<div id="mobile">

								<div class="panel">

									<a data-toggle="collapse" data-parent="#mobile" href="#mobile1" aria-expanded="true">Mobile app</a>

									<div id="mobile1" class="collapse in">

										<ol>

											<li>Use the apps based on employee demand.</li>

											<li>It is a completely natural process because it is a fully functional application.</li>

											<li>It offers the best services.</li>
								...
								<div class="panel">
									...
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile2">Separate mobile app for manager and employees</a>

									<div id="mobile2" class="collapse">

										<ol>

											<li>Apply sheets through this mobile application.</li>

											<li>See all plans and policies.</li>

											<li>View tax related data.</li>

											<li>Access the payrolls.</li>
								...
								<div class="panel">
									...
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile3">Payroll data</a>

									<div id="mobile3" class="collapse">

										<ol>

											<li>View updated payroll information.</li>

											<li>Understand the tax savings plan and deduction.</li>

											<li>Download the statements of total earnings, YTD and PF.</li>
								...
								<div class="panel">
									...
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile4">Simplify processes

									</a>

									<div id="mobile4" class="collapse">

										<ol>

											<li>Automate the request for license orders, services, inquiries, etc.

											</li>

											<li>In a single "tap" you can see the status of your requests.

											</li>

											<li>View the history in real time and everything organized.
								...
								<div class="panel">
									...
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile5">Features of mobile brand support.

									</a>

									<div id="mobile5" class="collapse">

										<ol>

											<li>Use the geo-mark to cross the attendance mark data with where the mark was issued.

											</li>

											<li>If they need a higher Security capacity or an alternative, the application can work as a biometric clock by using facial recognition to make the attendance mark.

											</li>

											<li>You can set multiple locations where you have to make the mark,
								...
								<div class="panel">
									...
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile6">Help desk

									</a>

									<div id="mobile6" class="collapse">

										<ol>

											<li>Useful help tool for various departments (IT, Finance, Administration, etc.).
