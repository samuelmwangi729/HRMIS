...
<html>
	...
	<head>
		...
		<title>Cloud-based Online Payroll Management Software</title>

		<meta name="description" content="Hrms Maxx Provides the cloud-based payroll management software, It helps you to simplify your calculations like salary process, TDS and much more.">
				...
				<div class="container-fluid shrhcontainer">
					...
					<div class="custom-navbar-default no-radius navbar navbar-default navbar-affixed-top mb-0" data-spy="affix" data-offset-top="100" >
						...
						<div class="row xs-style vertical-align">
							...
							<div class="col-sm-4 col-xs-6 logo"><a href="<?php echo base_url(); ?>"><img class="img img-responsive" src="<?php echo base_url(); ?>assets/img/logo6.png" alt="HRMS Maxx" width="150"/></a></div>
													...
													<div class="menu-mobile">
														...
														<ul>
															...
															<li>
																...
																<a href="<?=base_url()?>home/payroll_software" class="active center-block">
															...
															<li>
																...
																<a href="<?=base_url()?>home/attendance_management_software" class="center-block">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-lg-push-6 col-md-6 col-md-push-6 image-column features-slide features-left-blk">
							...
							<div class="features-pad">
								...
								<div class="img-box shadow-lg">
									...
									<img class="img-center" src="<?=base_url()?>assets/img/slide-33.png" alt="">
						...
						<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
							...
							<div class="features-pad">
								...
								<h1>Payroll management software</h1>

								<p>One of the most tedious and difficult processes is <a href="<?=base_url()?>home/payroll_software">payroll management</a>because there is a need to perform large calculations under different parameters, discounts. <br>

									In addition, the requirements of <b>Legal compliance</b>they are complex to manage. Everyone waits for the stress-free solution to handle these processes and get the package safe and accurate. Our payroll management system is one of the best software in India. You can approach any payroll process in all aspects.
								...
								<div id="payroll">
									...
									<div class="panel">
										...
										<a data-toggle="collapse" data-parent="#payroll" href="#payroll1" aria-expanded="true">Simple click to process payroll</a>

										<div id="payroll1" class="collapse in">

											<ol>

												<li>Use the tools to extend reconciliation.

												</li>

												<li>Calculate exact wages.
												...
												<li>Use the checklist for a guide to processing payroll.

												</li>

												<li>Ease to disburse wages.
									...
									<div class="panel">
										...
										<a data-toggle="collapse" data-parent="#payroll" href="#payroll2">Regulations and audits

										</a>

										<div id="payroll2" class="collapse">

											<ol>

												<li>Simple to make legal payroll reports.
									...
									<div class="panel">
										...
										<a data-toggle="collapse" data-parent="#payroll" href="#payroll3">Salary structure

										</a>

										<div id="payroll3" class="collapse">

											<ol>

												<li>Allow multiple salary components.

												</li>

												<li>Set up the difficult structure of wages.
									...
									<div class="panel">
										...
										<a data-toggle="collapse" data-parent="#payroll" href="#payroll4">Generate automatic entries.

										</a>

										<div id="payroll4" class="collapse">

											<ol>

												<li>Generate personalized pay stubs.

												</li>

												<li>Calculate loans and repayments.
				...
				<div class="container overflow-hidden">
					...
					<div class="row align-items-center vertical-align">
						...
						<div class="col-md-6">
							...
							<img class="img img-responsive" src="<?=base_url()?>assets/img/customer-review.png" alt="Images"/>
						...
						<div class="col-md-6">
							...
							<div class="section-heading">
								...
								<h2 class="">The most complete human resources platform !!</h2>
						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="2300">
							...
							<div class="carousel-inner shadow-lg">
								...
								<div class="item active">
									...
									<p class="para-line m-t-30">As HR-Talent Acquisition, I believe that HRMS Maxx is one of the best HR software solutions available that I have come across. The new HRMS has been an extremely easy to use and interactive application.</p>

									<ul class="list-unstyled custom-center align-items-center">

										<li class="media flex-column flex-md-row text-center text-md-left">

											<img class="img img-responsive mr-14" src="<?=base_url()?>assets/img/client-img.png" alt="Images"/>
								...
								<div class="item">
									...
									<p class="para-line m-t-30">From the moment I started using HRMS Maxx, I felt calmer. It just made sense. The implementation process could not have been easier: I didn't have to spend hours monitoring the people in it. The best attendance management software.</p>

									<ul class="list-unstyled custom-center align-items-center">

										<li class="media flex-column flex-md-row text-center text-md-left">

											<img class="img img-responsive mr-14" src="<?=base_url()?>assets/img/client-img-2.png" alt="Images"/>
								...
								<div class="item">
									...
									<p class="para-line m-t-30">
										...
										HRMS Maxx is the only online HR software that is exactly what we expect for our company. It's easy to use and a real asset for employees, managers and human resources!

										The best HR solution I've ever used!
									</p>
									...
									<ul class="list-unstyled custom-center align-items-center">
										...
										<li class="media flex-column flex-md-row text-center text-md-left">
											...
											<img class="img img-responsive mr-14" src="<?=base_url()?>assets/img/client-img-3.png" alt="Images"/>
								...
								<div class="item">
									...
									<p class="para-line m-t-30">After joining HRMS Maxx, technology has never been a problem for us. We have seen a multiple increase in productivity. The product is so easy to use that even employees with no payroll processing experience can get started in just a few weeks.</p>

									<ul class="list-unstyled custom-center align-items-center">

										<li class="media flex-column flex-md-row text-center text-md-left">

											<img class="img img-responsive mr-14" src="<?=base_url()?>assets/img/client-img-4.png" alt="Images"/>
								...
								<div class="item">
									...
									<p class="para-line m-t-30">
										...
										HRMS Maxx is an active partner in the effort to make payroll and employee relationships easier and more productive. Their customer service, dedicated team, and great product features got us moving forward with them and we look forward to continuing this relationship as an excellent employee experience partner.
									...
									<ul class="list-unstyled custom-center align-items-center">
										...
										<li class="media flex-column flex-md-row text-center text-md-left">
											...
											<img class="img img-responsive mr-14" src="<?=base_url()?>assets/img/client-img-5.png" alt="Images"/>
							...
							<span class="carousel-control-prev-icon" aria-hidden="true"><img src="<?=base_url()?>assets/img/arrow-left.png" alt="Image"/></span>
							...
							<span class="carousel-control-next-icon" aria-hidden="true"><img src="<?=base_url()?>assets/img/arrow-right.png" alt="Image"/></span>
										...
										<form id="frm_contact" role="form" autocomplete="off" method="POST" class="RequestDemoFrm">
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-md-6 col-sm-6 col-xs-12"><input type="text" class="form-control" name="contactname" placeholder="Full name
												...
												<div class="row NotQuote">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														...
														<div class="input-group date m-b-23" data-provide="datepicker">
															...
															<input type="text" class="form-control mb-0" placeholder="Select your best date " id="app_date" name="demo_date">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														...
														<div class="input-group time m-b-23" id="timepicker">
															...
															<input class="form-control mb-0" placeholder="Available Time" name="demo_time" />
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-md-6 col-sm-6 col-xs-12"><input type="tel" class="form-control" name="contactpincode" placeholder="Number of officials
