													...
													<ul>
														...
														<li>
															...
															<li>
																...
																<a href="<?=base_url()?>home/crm" class="active center-block">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-lg-push-6 col-md-6 col-md-push-6 image-column features-slide features-left-blk">
						...
						<div class="features-pad">
							...
							<div class="img-box shadow-lg">
								...
								<img class="img-center" src="<?=base_url()?>assets/img/crm.png" alt="">
					...
					<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
						...
						<div class="features-pad">
							...
							<h1>CLOSE MORE AND BETTER SALES</h1>

							<p>CRM makes life easier for you, so you can sell and focus on continuing to sell.
							...
							<div id="mobile">
								...
								<div class="panel">
									...
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile1" aria-expanded="true"></a>
									...
									<div id="mobile1" class="collapse in">
										...
										<ol>
											...
											<li>Capture more qualified leads.

											</li>

											<li>Track opportunities, calls, emails, and contacts. </li>
