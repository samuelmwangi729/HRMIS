													...
													<ul>
														...
														<li>
															...
															<li>
																...
																<a href="<?=base_url()?>home/cloud_computing" class="active center-block">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-lg-push-6 col-md-6 col-md-push-6 image-column features-slide features-left-blk">
					...
					<div class="features-pad">
						...
						<div class="img-box shadow-lg">
							...
							<img class="img-center" src="<?php echo base_url()?>assets/img/banner-slide-12.png" alt="" width="80%;" height="50">
				...
				<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
					...
					<div class="features-pad">
						...
						<p>Instead of paying for electricity, wiring, conditioning, computer equipment, dedicated personnel, etc.

The providers of these solutions managed to host these solutions in a cloud computing environment.

Applications are accessed through the Internet, quite simple.
						</p>
						...
						<div id="mobile">
							...
							<div class="panel">
								...
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile1" aria-expanded="true">Not all HR systems that are in the cloud are the same.

								There are two major classifications of this type of solution on the market:
								...
								<div id="mobile1" class="collapse in">
									...
									<ol>
										...
										<li>The "Cloud Compatible" or that can be "Migrated to the cloud".</li>

										<li>The "Developed for the Cloud", "Native in the Cloud" or "Web Based".
							...
							<div class="panel">
								...
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile2">However, many of these Human Resources solutions are old. The "Cloud Compatible" or "Migrated to the cloud" since they have been including connectivity and online accessibility features. </a>
							...
							<div class="panel">
								...
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile3">In conclusion, they lack many of the advantages of solutions that are "Developed for the Cloud", "Native in the Cloud" or "Web Based"</a>
							...
							<div class="panel">
								...
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile4">that have been structured taking into account agile methodologies, massive scalability and fast, remote and global implementations.</a>
