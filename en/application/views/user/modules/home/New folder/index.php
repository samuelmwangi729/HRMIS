<?php
    ...
    $this->website_name = '';
    $website_logo_front ='https://res.cloudinary.com/dreamguys/image/upload/v1567583393/newhrms/logo_yl4tjk.png';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta name="description" content="Build your better workplace with NewHRMS.  It is one of the best HR Management Software which builds for any type of business. 100% Customizable software.">
	...
	<div class="inner-wrapper shr-wrapper">
               ...
               <div class="custom-navbar-default no-radius navbar navbar-default navbar-affixed-top mb-0" data-spy="affix" data-offset-top="100" >
                  <div class="row xs-style vertical-align">
                     ...
                     <div class="col-sm-8 col-xs-6">
                        <ul class="mainnav">
                           <li class="hidden-xs"><a href="livetest" class="scroll-to">Demo</a></li>
                           <li class="hidden-xs dropdown"><a href="#features" class="scroll-to" class="btn-border dropdown-toggle" data-toggle="dropdown">Features &nbsp;<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            <ul class="custom-dropdown dropdown-menu">
                              <li><a href="core-hr-software">Core HR</a></li>
                              <li><a href="payroll-software">Payroll</a></li>
                              <li><a href="leave-management-software">Leave</a></li>
                              <li><a href="attendance-management-software">Attendance</a></li>
                              <li><a href="employee-self-service-portal">ESS Portal</a></li>
                                 ...
                                 <div class="col-md-8">
                                    <div class="menu-section1">
                                       <div class="menu-mobile">
                                          <ul class="" id="">
                                             <li><a href="livetest">Demo</a></li>
                                             <li><a data-toggle="collapse"  href="#featureSubmenu">Features <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                              <ul id="featureSubmenu" class="collapse sub-menu">
                                                <li><a href="core-hr-software">Core HR</a></li>
                                                <li><a href="payroll-software">Payroll</a></li>
                                                <li><a href="leave-management-software">Leave</a></li>
                                                <li><a href="attendance-management-software">Attendance</a></li>
                           ...
                           <div class="image-column features-slide features-left-blk">
                              <div class="features-blk-slide">
                                 <div class="img-box shadow-lg">
                                    ...
                                    <img class="img-center" src="https://res.cloudinary.com/dreamguys/image/upload/v1567583396/newhrms/banner-slide-1_ffeqj4.jpg" srcset="https://res.cloudinary.com/dreamguys/image/upload/v1567583396/newhrms/banner-slide-1_ffeqj4.jpg" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="image-column features-slide features-left-blk">
                              <div class="features-blk-slide">
                                 <div class="img-box shadow-lg">
                                    ...
                                    <img class="img-center" src="https://res.cloudinary.com/dreamguys/image/upload/v1567583396/newhrms/banner-slide-2_kvvr3f.jpg" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="image-column features-slide features-left-blk">
                              <div class="features-blk-slide">
                                 <div class="img-box shadow-lg">
                                    ...
                                    <img class="img-center" src="https://res.cloudinary.com/dreamguys/image/upload/v1567583397/newhrms/banner-slide-3_lppejx.jpg" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="container">
               ...
               <div class="video-box">
                  ...
                  <div class="side-image">
                     <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584392/newhrms/newhrms-landing/video-watching-men_oporqc.png" alt="">
                  </div>
               </div>
            </div>
         </section>
                     ...
                     <div class="owl-carousel features-carousel owl-theme">
                        <div class="item">
                           <div class="features-blk-slide">
                              <div class="row">
                                 ...
                                 <div class="col-sm-8">
                                    <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/employees-tab-img_aohfgb.jpg" alt="Employees - NewHRMS Dashboard" />
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/payroll-tab-img_u6tt3e.jpg" alt="Attendance - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584392/newhrms/newhrms-landing/task-tab-img_px5qns.jpg" alt="Task - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/payroll-tab-img_u6tt3e.jpg" alt="Payroll - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584392/newhrms/newhrms-landing/projects-tab-img_hknaio.jpg" alt="Projects - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/event-tab-img_o6bc1h.jpg" alt="Events - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                        ...
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584390/newhrms/newhrms-landing/clients-tab-img_lncfdh.jpg" alt="Clients - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584390/newhrms/newhrms-landing/chat-tab-img_oqgf1d.jpg" alt="Chat - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584390/newhrms/newhrms-landing/accounts-tab-img_gc8rd6.jpg" alt="Accounts - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                        <div class="features-blk-slide">
                           <div class="row">
                              ...
                              <div class="col-sm-8">
                                 <img class="img img-responsive" src="https://res.cloudinary.com/dreamguys/image/upload/v1567584392/newhrms/newhrms-landing/settings-tab-img_q9mvbp.jpg" alt="Settings - NewHRMS Dashboard" />
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="tab-content">
                     ...
                     <div role="tabpanel" class="tab-pane active" id="employees">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/employees-tab-img_aohfgb.jpg" alt="Employees - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 1 -->
                     <!-- Tab 2 --> 
                     <div role="tabpanel" class="tab-pane" id="attendance">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/payroll-tab-img_u6tt3e.jpg" alt="Attendance - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 2 -->
                     <!-- Tab 3 -->
                     <div role="tabpanel" class="tab-pane" id="task">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584392/newhrms/newhrms-landing/task-tab-img_px5qns.jpg" alt="Task - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 3 -->
                     <!-- Tab 4 -->
                     <div role="tabpanel" class="tab-pane" id="payroll">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/payroll-tab-img_u6tt3e.jpg" alt="Payroll - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 4 -->
                     <!-- Tab 5 -->
                     <div role="tabpanel" class="tab-pane" id="projects">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584392/newhrms/newhrms-landing/projects-tab-img_hknaio.jpg" alt="Projects - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 5 -->
                     <!-- Tab 6 -->
                     <div role="tabpanel" class="tab-pane" id="events">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/event-tab-img_o6bc1h.jpg" alt="Events - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 6 -->
                     <!-- Tab 7 -->
                     <div role="tabpanel" class="tab-pane" id="clients">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584390/newhrms/newhrms-landing/clients-tab-img_lncfdh.jpg" alt="Clients - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 7 -->
                     <!-- Tab 8 -->
                     <div role="tabpanel" class="tab-pane" id="chat">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584390/newhrms/newhrms-landing/chat-tab-img_oqgf1d.jpg" alt="Chat - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 8 -->
                     <!-- Tab 9 -->
                     <div role="tabpanel" class="tab-pane" id="accounts">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584390/newhrms/newhrms-landing/accounts-tab-img_gc8rd6.jpg" alt="Accounts - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 9 -->
                     <!-- Tab 10 -->
                     <div role="tabpanel" class="tab-pane" id="settings">
                        <div class="row">
                           ...
                           <div class="col-md-8 text-right"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584392/newhrms/newhrms-landing/settings-tab-img_q9mvbp.jpg" alt="Settings - NewHRMS Dashboard" /></div>
                        </div>
                     </div>
                     <!-- Tab 10 -->
                  </div>
               ...
               <div class="row">
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="services-box">
                        <div class="icon">
                           <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/features-icons-new-hrms/icon-grid-1_nvcal4.png" />
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="services-box">
                        <div class="icon">
                           <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/features-icons-new-hrms/icon-grid-2_xotgzx.png" />
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="services-box">
                        <div class="icon">
                           <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/features-icons-new-hrms/icon-grid-3_pxh4np.png" />
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="services-box">
                        <div class="icon">
                           <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/features-icons-new-hrms/icon-grid-4_zzhzoq.png" />
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="services-box">
                        <div class="icon">
                           <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/features-icons-new-hrms/icon-grid-5_xehujq.png" />
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="services-box">
                        <div class="icon">
                           <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567584391/newhrms/newhrms-landing/features-icons-new-hrms/icon-grid-6_n8ybuh.png" />
                        </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-7 col-md-7">
                     <div class="screenshot-contain">
                        <img class="mobile-light-left" src="https://res.cloudinary.com/dreamguys/image/upload/v1567583393/newhrms/light_gwqazy.png" alt="light">
                        <img class="mob-mocup img-fluid hidden-xs" src="https://res.cloudinary.com/dreamguys/image/upload/v1567583395/newhrms/screenshot-mob_pk5nnm.png" alt="screenshot-mob">
                        <img class="mobile-light-right" src="https://res.cloudinary.com/dreamguys/image/upload/v1567583393/newhrms/light_gwqazy.png" alt="light-right">
                        <div class="screenshot-carousel owl-carousel owl-theme">
                           <div class="screenshot-item">
                              <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567583394/newhrms/screen1_ffbcak.png" alt="app">
                           </div>
                           <div class="screenshot-item">
                              <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567583394/newhrms/screen2_fh3bds.png" alt="app">
                           </div>
                           <div class="screenshot-item">
                              <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567583395/newhrms/screen5_hrhnkj.png" alt="app">
                           </div>
                           <div class="screenshot-item">
                              <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567583395/newhrms/screen4_xjytjo.png" alt="app">
                           </div>
                           <div class="screenshot-item">
                              <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567583395/newhrms/screen3_nnddyg.png" alt="app">
                           </div>
                           <div class="screenshot-item">
                              <img src="https://res.cloudinary.com/dreamguys/image/upload/v1567583395/newhrms/screen5_hrhnkj.png" alt="app">
                           </div>
      ...
      <section class="section integration-bubbles pad-lg">
         <?php /*?><div class="bg-animation">
            <img class="zoom-fade" src="https://res.cloudinary.com/dreamguys/image/upload/v1567583394/newhrms/pattern-bg_oa8fcu.png" alt="" />
         </div><?php */?>
         <div class="container overflow-hidden">
            <div class="row align-items-center vertical-align">
               <div class="col-md-6">
                  <?php /*?><div class="bubbles-wrapper hidden-xs">
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-3 sm-mb-41">
                  <div class="logo"><a href="<?php echo base_url();?>"><img src="https://res.cloudinary.com/dreamguys/image/upload/v1567583393/newhrms/logo-white_qiwray.png" /></a></div>
