...
<html>
	...
	<head>
		...
		<title>Cloud-based HR Software - Best Human Resource Software</title>

		<meta name="description" content="Hrms Maxx provides complete HR Software with mobile applications. Automate your HR operations & 100% Source-code & Easy-to-customize as per your business.">
													...
													<div class="menu-mobile">
														...
														<ul>
															...
															<li>
																...
																<a href="<?=base_url()?>home/core_hr_software" class=" active center-block">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 image-column features-slide features-left-blk">
							...
							<div class="features-pad">
								...
								<div class="img-box shadow-lg">
									...
									<img class="img-center" src="<?php echo base_url()?>assets/img/banner-slide-2.png" alt="">
						...
						<div class="col-lg-6 col-md-6 md-mt-5 ml-auto">
							...
							<div class="features-pad">
								...
								<h1>Core Human Resource Management Software</h1>

								<p>The main module is the main piece to implement the best practices of Human Resources.
								...
								<div id="corehr">
									...
									<div class="panel">
										...
										<a data-toggle="collapse" data-parent="#corehr" href="#corehr1" aria-expanded="true">The Central module includes :</a>

										<div id="corehr1" class="collapse in">

											<ol>

												<li>Time & Attendance </li>

												<li>Shift and Schedule Coordinator</li>

												<li>Official Information</li>

												<li>Incorporation & Termination</li>

												<li>License Managements</li>

												<li>Dynamic control panel</li>

												<li>Advanced Reports</li>

												<li>Documents. and files</li>

												<li>Organization chart and hierarchies</li>
					...
					<div class="modal-body">
						...
						<div class="hrms-contact-form">
							...
							<div class="contact-registration">
								...
								<form id="buynow_form" role="form" action="#" method="POST" autocomplete="off">
