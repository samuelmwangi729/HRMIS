...
<html>
	...
	<head>
		...
		<title>Cloud-based Online Leave Management Software</title>

		<meta name="description" content="Hrms Maxx provides the most reliable cloud-based leave management software, It helps you to manage your employee's leave information with single click.">
													...
													<div class="menu-mobile">
														...
														<ul>
															...
															<li>
																...
																<a href="<?php echo base_url()?>home/leave_management_software" class="active center-block">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 image-column features-slide features-left-blk">
							...
							<div class="features-pad">
								...
								<div class="img-box shadow-lg">
									...
									<img class="img-center" src="<?php echo base_url(); ?>assets/img/banner-slide-4.png" alt="">
						...
						<div class="col-lg-6 col-md-6 md-mt-5 ml-auto">
							...
							<div class="features-pad">
								...
								<h1>Employee License Management Software</h1>

								<p>La <a href="<?php echo base_url(); ?>home/leave_management_software">Employee License Managements</a>You must streamline the process of a single process.</p>

								<div id="leave">

									<div class="panel">

										<a data-toggle="collapse" data-parent="#leave" href="#leave1" aria-expanded="true">License management is the best opportunity:</a>

										<div id="leave1" class="collapse in">

											<ol>

												<li>Employee can easily track .</li>

												<li>Helps develop employee satisfaction and transparency.</li>

												<li>Manages period activities, grants and accounting.</li>
