...
<html>
	...
	<head>
		...
		<meta name="description" content="Hrms Maxx provides Employee Self-Service portal, By using this system employee can submit personal information, apply for leave and much more.">
		...
		<link rel="stylesheet" type="<?php echo base_url()?>text/css" href="assets/css/flaticon.css" />
													...
													<div class="menu-mobile">
														...
														<ul>
															...
															<li>
																...
																<a href="<?=base_url()?>home/employee_self_service_portal" class="active center-block">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 image-column features-slide features-left-blk">
							...
							<div class="features-pad">
								...
								<div class="img-box shadow-lg">
									...
									<img class="img-center" src="<?php echo base_url()?>assets/img/banner-slide-6.png" alt="">
						...
						<div class="col-lg-6 col-md-6 md-mt-5 ml-auto">
							...
							<div class="features-pad">
								...
								<p>The Self-Service Portal increases motivation and confidence every time it improves employee access. <br>

									It is a type of employee portal that insists on greater online access for information on:<br>

									Your goals accomplished<br>

									His career in the company<br>

									Your chores to do<br>

									Your pay stubs<br>

									Your attendance behavior<br>

									News and messages.

								</p>

								<p> It ensures transparency, superior quality, better communication, responsiveness, and standardized processes. <br>

									The Self-Service Portal interacts with the ingenious mobile application with the purpose of accessing from anywhere and at any time.
									...
									<div class="panel">
										...
										<div id="essportal1" class="collapse in">
											...
											<ol>
												...
												<li>See letters and documents.</li>

												<li>Follow the forms and policies.</li>

												<li>Find employee data.</li>

												<li>Take advantage of the use of social networks.</li>
