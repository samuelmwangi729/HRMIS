...
?>
    ...
    <head>
		...
		<meta name="description" content="Newhrms provides complete HR Software with mobile applications. Automate your HR operations & 100% Source-code & Easy-to-customize as per your business.">
                        	...
                        	<div class="features-pad">
                                ...
                                <div id="corehr">
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#corehr" href="#corehr2">Get the good experience of onboarding</a>

                                        <div id="corehr2" class="collapse">

                                        	<ol>

                                            	<li>Use only paperless process.</li>

                                                <li>Integrate all the documents.</li>

                                                <li>Ensure the novel compliance.</li>

                                                <li>Review all workflows.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#corehr" href="#corehr3">Notification, alerts and communication</a>

                                        <div id="corehr3" class="collapse">

                                        	<ol>

                                            	<li>Employee communication management system.</li>

                                                <li>Send notifications for alert.</li>

                                                <li>Use the templates for setting reminder.</li>

                                                <li>Regulate the forms and policies.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#corehr" href="#corehr4">Reports and dashboards of Core HR</a>

                                        <div id="corehr4" class="collapse">

                                        	<ol>

                                            	<li>Use temporary reports for HR MIS.</li>

                                                <li>Use the unique CEO dashboard.</li>

                                                <li>Use the separate HR dashboard.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#corehr" href="#corehr5">EDM (Employee Document Management)</a>

                                        <div id="corehr5" class="collapse">

                                        	<ol>

                                            	<li>Maintain the documents of all the employees.</li>

                                                <li>Access the documents if required.</li>

                                                <li>Send letters to employees.</li>
