												...
												<div class="menu-mobile">
													<ul>
														...
														<li>
															...
															<li>
																<a href="<?=base_url()?>home/ats" class="active center-block">
																<span>ATS</span>
																</a>
															</li>
															<li>
				...
				<div class="row">
					<div class="col-lg-6 col-lg-push-6 col-md-6 col-md-push-6 image-column features-slide features-left-blk">
						<div class="features-pad">
							<div class="img-box shadow-lg">
								...
								<img class="img-center" src="<?=base_url()?>assets/img/recuriting.png" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
						<div class="features-pad">
							...
							<div id="mobile">
								<div class="panel">
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile1" aria-expanded="true">LOS MEJORES CANDIDATOS EN TU EQUIPO.</a>
									<div id="mobile1" class="collapse in">
										<ol>
											<li>Gestiona todo el ciclo de vida de selección en un solo sistema, con planificación
												de la plantilla, contratación y analytics de talento avanzados.
											</li>
											<li>Atraiga a los empleados mejor preparados al ofrecer a los candidatos un proceso homogéneo y atractivo, desde el primer contacto hasta su incorporación a la plantilla.</li>
											<li>Agilice el proceso de selección al proporcionar transparencia y colaboración a todo el equipo de selección.</li>
											<li>Diseñado y optimizado para dispositivos móviles.</li>
											<li> Funciona de forma colaborativa y en tiempo real.</li>
										</ol>
									</div>
								</div>
							</div>
