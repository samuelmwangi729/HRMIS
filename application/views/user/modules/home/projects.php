...
<html>
	<head>
		...
		<title>Proyectos | Hrms Maxx</title>
		...
		<section class="pad-lg pos-r">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
					<div class="features-pad">
						<h1>Gestione, Automatice y Ahorre.</h1>
						<p>Plataforma completa de recursos humanos en la nube.</p>
						<div id="mobile">
							<div class="panel">
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile1" aria-expanded="true">Ayuda a gestionar el activo más importante de la empresa: El capital humano.</a>
								<div id="mobile1" class="collapse in">
									<ol>
										<li><a href="<?=base_url()?>" style="color:#333;">HRMS Maxx</a> ayuda en aumentar la productividad, ahorrarle tiempo de trabajo manual y monótono al automatizar procesos. Ahorros inmediatos de dinero al tener una única solución e integral de RRHH. </li>
										<li>Agiliza las comunicaciones entre y en los departamentos, de manera confiable y fácil  eficiente. Crea un entorno de trabajo inteligente y sin problemas.</li>
										<li>HRMS Maxx es una herramienta <a href="javascript:void(0);">“Nativa en la Nube” </a>indispensable completa y configurable para toda la empresa!.  </li>
									</ol>
								</div>
							</div>
