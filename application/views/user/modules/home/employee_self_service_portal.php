				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 md-mt-5 ml-auto">
							<div class="features-pad">
								<h1>Portal de Autoservicio</h1>
								<p>El portal de Autoservicio aumenta la motivación y la confianza cada vez que mejora el acceso de los empleados. <br>
									Es un tipo de portal para empleados que insiste en un mayor acceso en línea para obtener información sobre:<br>
									Sus objetivos cumplidos<br>
									Su trayectoria en la empresa<br>
									Sus tareas por ahacer<br>
									Sus recibos de sueldos<br>
									El comportamiento de su asistencia<br>
									Noticias y mensajes.
								</p>
								<p> Asegura transparencia, calidad superior, mejor comunicación, capacidad de respuesta y procesos estandarizados. <br>
									El portal de Autoservicio interactúa con la ingeniosa aplicación móvil con el propósito de acceder desde cualquier lugar y en cualquier momento.
								</p>
								<div id="essportal">
									<div class="panel">
										<a data-toggle="collapse" data-parent="#essportal" href="#essportal1" aria-expanded="true">Actividades basicas</a>
										<div id="essportal1" class="collapse in">
											<ol>
												<li>Acceda a la información personal.</li>
												<li>Ver las cartas y documentos.</li>
												<li>Siga los formularios y políticas.</li>
												<li>Buscar los datos del empleado.</li>
												<li>Aproveche el uso de las redes sociales.</li>
											</ol>
										</div>
									</div>
