				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
							<div class="features-pad">
								<h1>Software de gestión de nómina</h1>
								<p>Uno de los procesos mas tediosos y difíciles es la <a href="<?=base_url()?>home/payroll_software">gestión de la nómina </a>porque existe la necesidad de realizar grandes cálculos bajo diferentes parámetros conceptos descuentos. <br>
									Además, los requisitos de <b>cumplimiento legal</b> son complejos de gestionar. Todos esperan la solución libre de estrés para manejar estos procesos y obtener el paquete seguro y preciso. Nuestro sistema de gestión de nómina es uno de los mejores software de la India. Puede abordar cualquier proceso de nómina en todos los aspectos.
								</p>
								<div id="payroll">
									<div class="panel">
										<a data-toggle="collapse" data-parent="#payroll" href="#payroll1" aria-expanded="true">Simple clic para procesar la nómina</a>
										<div id="payroll1" class="collapse in">
											<ol>
												<li>Utilice las herramientas para extender la reconciliación.
												</li>
												<li>Calcule los salarios exactos.
												</li>
												<li>Completamente automático
												</li>
												<li>Use la lista de verificación para obtener una guía para procesar la nómina.
												</li>
												<li>Facilidad para desembolsar los salarios.
												</li>
											</ol>
										</div>
									</div>
									<div class="panel">
										<a data-toggle="collapse" data-parent="#payroll" href="#payroll2">Regulaciones y auditorías
										</a>
										<div id="payroll2" class="collapse">
											<ol>
												<li>Simple para hacer los informes legales de nómina.
												</li>
												<li>Administra las cuentas.
												</li>
											</ol>
										</div>
									</div>
									<div class="panel">
										<a data-toggle="collapse" data-parent="#payroll" href="#payroll3">Estructura salarial
										</a>
										<div id="payroll3" class="collapse">
											<ol>
												<li>Permitir los múltiples componentes salariales.
												</li>
												<li>Configurar la difícil estructura de los salarios.
												</li>
											</ol>
										</div>
									</div>
									<div class="panel">
										<a data-toggle="collapse" data-parent="#payroll" href="#payroll4">Generar entradas automáticas.
										</a>
										<div id="payroll4" class="collapse">
											<ol>
												<li>Genera los recibos de sueldo personalizados.
												</li>
												<li>Calcule los préstamos y reembolsos.
												</li>
											</ol>
										</div>
									</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 sm-mb-41">
							<div class="logo"><a href="<?=base_url()?>"><img src="<?=base_url()?>assets/img/logo-white.png" alt="Images"/></a></div>
