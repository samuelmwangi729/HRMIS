				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 md-mt-5 ml-auto">
							<div class="features-pad">
								<h1>Software principal de gestión de recursos humanos</h1>
								<p>El módulo principal es la pieza principal para implementar las mejores prácticas de Recursos Humanos.
								</p>
								<div id="corehr">
									<div class="panel">
										<a data-toggle="collapse" data-parent="#corehr" href="#corehr1" aria-expanded="true">El módulo Central incluye :</a>
										<div id="corehr1" class="collapse in">
											<ol>
												<li>Tiempo & Asistencia </li>
												<li>Coordinador de Turnos y Horarios</li>
												<li>Información de Funcionario</li>
												<li>Incorporación & Cese</li>
												<li>Gestión de Licencias</li>
												<li>Panel de control dinámico</li>
												<li>Reportes Avanzados</li>
												<li>Documentos. y legajos</li>
												<li>Organigrama y Jerarquías</li>
												<li>Calendarios y Eventos</li>
												<li>Documentos y legajos</li>
												<li>Chat y Videollamadas</li>
												<li>Proyectos</li>
												<li>Tareas.</li>
