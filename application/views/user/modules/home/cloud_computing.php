			...
			<div class="row">
				...
				<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
					<div class="features-pad">
						...
						<p>En vez de estar pagando por gastos de luz, cableado, acondicionamiento, equipos de informática, personal dedicado, etc.
							Los proveedores de estas soluciones se las ingeniaron en alojar estas soluciones en un entorno de computación en la nube. 
							Se accede a las aplicaciones a través de Internet, bastante sencillo.
						</p>
						<div id="mobile">
							<div class="panel">
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile1" aria-expanded="true">No todos los sistemas RRHH que están en la nube son iguales. 
								En el mercado existen dos grandes clasificaciones de este tipo de soluciones:
								</a>
								<div id="mobile1" class="collapse in">
									<ol>
										<li>Las “Compatibles para la Nube” o que pueden ser “Migradas hacia la nube”.</li>
										<li>Las “Desarrolladas para la Nube”, “Nativas en la Nube” o “Basadas en Web” .
										</li>
									</ol>
								</div>
							</div>
							<div class="panel">
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile2">Sin embargo, muchas de estas soluciones de Recursos Humanos son antiguas. Las “Compatibles para la Nube” o “Migrados hacia la nube” ya que se les ha ido incluyendo funcionalidades de conectividad y accesibilidad online. </a>
								<div id="mobile2" class="collapse">
									
								</div>
							</div>
							<div class="panel">
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile3">En conclusión, carecen de muchas de las ventajas de las soluciones que son “Desarrolladas para la Nube”, “Nativas en la Nube” o “Basadas en Web”</a>
								<div id="mobile3" class="collapse">
								
								</div>
							</div>
							<div class="panel">
								<a data-toggle="collapse" data-parent="#mobile" href="#mobile4">que se han estructuradas teniendo en cuenta las metodologías ágiles, escalabilidad masiva e implementaciones rápidas, remotas y globales.</a>
