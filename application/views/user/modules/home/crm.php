			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
						<div class="features-pad">
							<h1>CIERRE MÁS Y MEJORES VENTAS</h1>
							<p>El CRM  Le facilita la vida, para que puedas vender y enfocarte en seguir vendiendo. 
								Sí, así de redundante.
							</p>
							<div id="mobile">
								<div class="panel">
									...
									<div id="mobile1" class="collapse in">
										<ol>
											<li>Gestiona clientes potenciales y tratos</li>
											<li>Capta más clientes potenciales calificados.
											</li>
											<li>Haz seguimiento de las oportunidades, llamadas, correos electrónicos y contactos. </li>
										</ol>
									</div>
								</div>
