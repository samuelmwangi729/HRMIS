				...
				<div class="custom-navbar-default no-radius navbar navbar-default navbar-affixed-top mb-0" data-spy="affix" data-offset-top="100" >
					<div class="row xs-style vertical-align">
						...
						<div class="col-sm-8 col-xs-6">
							<ul class="mainnav">
								<li class="hidden-xs"><a href="<?=base_url()?>"  class="call-to-action">Página principal</a></li>
								<li class="visible-xs">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
						<div class="features-pad">
							<h1>Móvil</h1>
							<p>La aplicación no es una palabra porque se extiende por todo el mundo y es un gran diferencial nuestro el poder contar con una aplicacion nativa. La aplicación está en todas partes. Especialmente, el lugar de trabajo se debe usar la aplicación para el portal del empleado. Todas las empresas deben usar la aplicación del portal de empleados para atraer y proporcionar los mejores servicios. En este mundo moderno, la aplicación móvil funcional es completamente automática que se requiere para manejar a los empleados.</p>
							<div id="mobile">
								<div class="panel">
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile1" aria-expanded="true">Aplicación movil</a>
									<div id="mobile1" class="collapse in">
										<ol>
											<li>Use las aplicaciones según la demanda de los empleados.</li>
											<li>Es un proceso completamente natural porque es una aplicación totalmente funcional.</li>
											<li>Ofrece los mejores servicios.</li>
										</ol>
									</div>
								</div>
								<div class="panel">
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile2">Aplicación móvil separada para gerente y empleados</a>
									<div id="mobile2" class="collapse">
										<ol>
											<li>Aplicar hojas a través de esta aplicación móvil.</li>
											<li>Ver todos los planes y políticas.</li>
											<li>Ver los datos relacionados con los impuestos.</li>
											<li>Acceda a las nóminas.</li>
										</ol>
									</div>
								</div>
								<div class="panel">
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile3">Datos de nómina</a>
									<div id="mobile3" class="collapse">
										<ol>
											<li>Ver la información actualizada de la nómina.</li>
											<li>Comprender el plan de ahorro de impuestos y la deducción.</li>
											<li>Descargue las declaraciones de ganancias totales, YTD y PF.</li>
										</ol>
									</div>
								</div>
								<div class="panel">
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile4">Simplifica los procesos
									</a>
									<div id="mobile4" class="collapse">
										<ol>
											<li>Automatiza la solicitud de órdenes de licencias, servicios, consultas, etc.
											</li>
											<li>En un solo “tap” podes ver el estado de tus solicitudes .
											</li>
											<li>Ver el historial en tiempo real y todo organizado.
											</li>
										</ol>
									</div>
								</div>
								<div class="panel">
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile5">Características de la asistencia de marca en móviles.
									</a>
									<div id="mobile5" class="collapse">
										<ol>
											<li>Utiliza la geo-marca para cruzar los datos de marca de asistencia con el lugar donde emitieron la marca.
											</li>
											<li>Si precisan una capaz mayor de seguridad o una alternativa, la aplicación puede funcionar como reloj biometrico al utilizar reconocimiento facial para realizar la marca de asistencia.
											</li>
											<li>Se puede setear múltiples ubicaciones en donde tiene que realizar la marca,
											</li>
										</ol>
									</div>
								</div>
								<div class="panel">
									<a data-toggle="collapse" data-parent="#mobile" href="#mobile6">Mesa de ayuda
									</a>
									<div id="mobile6" class="collapse">
										<ol>
											<li>Herramienta útil de ayuda para varios departamentos (TI, Finanzas, Administración, etc).
											</li>
										</ol>
									</div>
								</div>
