				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 md-mt-5 ml-auto">
							<div class="features-pad">
								<h1>Software de gestión de licencias de empleados</h1>
								<p>La <a href="<?php echo base_url(); ?>home/leave_management_software">gestión de licencias de los empleados</a> debe agilizar el proceso de un solo proceso.</p>
								<div id="leave">
									<div class="panel">
										<a data-toggle="collapse" data-parent="#leave" href="#leave1" aria-expanded="true">La administración de licencias es la mejor oportunidad:</a>
										<div id="leave1" class="collapse in">
											<ol>
												<li>El empleado puede realizar un seguimiento fácil .</li>
												<li>Ayuda a desarrollar la satisfacción entre los empleados y la transparencia.</li>
												<li>Maneja  actividades del período, las subvenciones y la contabilidad.</li>
											</ol>
										</div>
									</div>
