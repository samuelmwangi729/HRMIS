...
?>
    ...
    <head>
		...
		<meta name="description" content="NewHRMS Provides the cloud-based payroll management software, It helps you to simplify your calculations like salary process, TDS and much more.">
                ...
                <div class="col-xs-12">
                  <div class="secondary-nav-link text-center">
                    <ul class="list-unstyled list-inline">
                      ...
                      <li>
                        <a href="payroll-software" class="active center-block">
                          <span>Payroll</span>
                        </a>
                      </li>
                      <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-lg-pull-6 col-md-6 col-md-pull-6 md-mt-5 ml-auto">
                        	...
                        	<div class="features-pad">
                                ...
                                <p>One of the difficult processes is <a href="https://www.newhrms.com/payroll-software">payroll management</a> because there is a necessity to perform the huge calculations. Also, the requirements of statutory compliance in which is complex to handle. Everyone expects the stress free solution for handle these processes and get the secure and accurate package. Our payroll management system is one among the best software in India. It can able to tackle any payroll process in all the aspects.</p>
                                ...
                                <div id="payroll">
                                	...
                                	<div class="panel">
                                        ...
                                        <div id="payroll1" class="collapse in">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Utilize the tools to extend the reconciliation.</li>

                                                <li>Calculate the exact salaries.</li>

                                                <li>Fully automatic.</li>

                                                <li>Use the checklist for get guide to process payroll.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#payroll" href="#payroll2">Salary structure</a>

                                        <div id="payroll2" class="collapse">

                                        	<ol>

                                            	<li>Allow the multiple salary components.</li>

                                                <li>Configure the difficult structure of salaries.</li>                                                
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#payroll" href="#payroll3">Generate automatic payslips and payroll inputs</a>

                                        <div id="payroll3" class="collapse">

                                        	<ol>

                                            	<li>Generate the customized payslips.</li>

												<li>Compute the loans and reimbursements.</li>
                                    ...
                                    <div class="panel">
                                        ...
                                        <a data-toggle="collapse" data-parent="#payroll" href="#payroll4">Vasty process in post payroll</a>

                                        <div id="payroll4" class="collapse">

                                            <ol>

                                                <li>Ease to disburse the salaries.</li>

                                                <li>Simple to make the statutory payroll reports.</li>

                                                <li>Manage the accounts.</li>
