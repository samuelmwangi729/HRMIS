                ...
                <div class="col-xs-12">
                  <div class="secondary-nav-link text-center">
                    <ul class="list-unstyled list-inline">
                      ...
                      <li>
                        <a href="mobile-app" class="active center-block">
                          <span>Mobile</span>
                        </a>
                      </li>
                    </ul>
                        ...
                        <div class="col-lg-6 col-lg-push-6 col-md-6 col-md-push-6 image-column features-slide features-left-blk">
                            ...
                            <div class="features-pad">
                                ...
                                <div class="img-box shadow-lg">
                                	...
                                	<img class="img-center" src="<?php echo base_url();?>assets/images/mobile-screens.png" alt="">
                        	...
                        	<div class="features-pad">
                                ...
                                <div id="mobile">
                                	...
                                	<div class="panel">
                                        ...
                                        <div id="mobile1" class="collapse in">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Use the apps as per the demand of employees.</li>

                                                <li>It is entirely natural process because it is fully functional app.</li>

                                                <li>Offers best services.</li>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="mobile2" class="collapse">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>Apply leaves through this mobile app.</li>

                                                <li>View all the plans and policies.</li>

                                                <li>View the tax related data.</li>

                                                <li>Access the payslips.</li>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="mobile3" class="collapse">
                                        	...
                                        	<ol>
                                            	...
                                            	<li>View the updated payroll information.</li>

                                                <li>Understand the tax saving plan and deduction.</li>

                                                <li>Download the statements of total earning, YTD and PF.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#mobile" href="#mobile4">Leave management</a>

                                        <div id="mobile4" class="collapse">

                                        	<ol>

                                            	<li>Get the approval of leave.</li>

                                                <li>Check their leave balances by their mobile with single tap.</li>

                                                <li>Updated holiday details.</li>

                                                <li>View all the leave related data.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#mobile" href="#mobile5">Features of geo mark attendance</a>

                                        <div id="mobile5" class="collapse">

                                        	<ol>

                                            	<li>Mobile app enables with the Geo mark for marking attendance.</li>

                                                <li>Low cost of mobile devices and hardware.</li>

                                                <li>Set the multiple locations.</li>

                                                <li>Capture the exact attendance information.</li>
                                    ...
                                    <div class="panel">
                                    	...
                                    	<a data-toggle="collapse" data-parent="#mobile" href="#mobile6">Help desk</a>

                                        <div id="mobile6" class="collapse">

                                        	<ol>

                                            	<li>Utilize HR help desk.</li>

                                                <li>Utilize IT help desk.</li>

                                                <li>Utilize Account help desk.</li>

                                                <li>Utilize Admin help desk.</li>
