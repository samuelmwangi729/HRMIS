...
// $route['admin'] = 'appsumo/appsumo/dashboard';
$route['admin/emailsettings'] = 'admin/settings/emailsettings';
$route['appsumo'] = 'appsumo/appsumo';
$route['appsumo/dashboard'] = 'appsumo/appsumo/dashboard';
$route['appsumo/coupon_management'] = 'appsumo/appsumo/coupon_management';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
